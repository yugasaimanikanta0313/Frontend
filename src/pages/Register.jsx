          ...
          <div className="p-6 pt-0">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full flex items-center justify-center bg-white border border-gray-300 py-2 rounded-lg hover:bg-gray-50 transition text-sm text-gray-700 font-medium"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center bg-black text-white py-2 rounded-lg hover:bg-gray-800 transition text-sm font-medium"
              >
                <svg className="w-5 h-5 mr-2" fill="white" viewBox="0 0 24 24">
                  <path d="M12 .5C5.65.5 .5 5.65 .5 12c0 5.1 3.3 9.4 7.9 10.9.6.1.8-.3.8-.6v-2c-3.2.7-3.9-1.5-3.9-1.5-.6-1.4-1.4-1.8-1.4-1.8-1.1-.7.1-.7.1-.7 1.3.1 2 1.3 2 1.3 1.1 2 3 1.5 3.7 1.1.1-.8.4-1.5.7-1.8-2.6-.3-5.4-1.3-5.4-5.8 0-1.3.5-2.4 1.3-3.3-.1-.3-.6-1.6.1-3.3 0 0 1.1-.3 3.5 1.3A12.1 12.1 0 0112 6c1.1 0 2.3.2 3.4.6 2.4-1.6 3.5-1.3 3.5-1.3.7 1.7.3 3 .2 3.3.8.9 1.2 2 1.2 3.3 0 4.5-2.8 5.4-5.5 5.7.4.3.7 1 .7 2v3c0 .3.2.7.8.6A10.5 10.5 0 0023.5 12C23.5 5.65 18.35.5 12 .5z"/>
                </svg>
                Sign up with GitHub
              </button>
            </div> */}
            ...
            <p className="text-center text-sm text-gray-600 mt-4">
              ...
              <a href="/login" className="text-[#4CAF50] font-medium hover:text-[#2E7D32] hover:underline">
                Sign in
              </a>
            </p>
          </form>
